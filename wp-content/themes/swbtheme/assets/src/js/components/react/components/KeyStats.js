...
class KeyStats extends Component {
  constructor(props) {
    ...
    this.animateTheFarm = this.animateTheFarm.bind(this);
  }
  ...
  componentDidMount() {
    ...
    const oppIcon = document.querySelector(
      ".np-keystats__stats--opportunity--header svg"
    );

    if (oppIcon !== null) {
      this.animateTheFarm(oppIcon);
    }
  }
            ...
            <div className="np-keystats__stats--opportunity">
              <div className="np-keystats__stats--opportunity--header">
                ...
                >
                  ...
                  />
                  <g className="np-clouds">
                    <path
                      className="cls-1 np-cloud np-cloud-one"
                    ...
                    />
                    <path
                      className="cls-1 np-cloud np-cloud-two"
