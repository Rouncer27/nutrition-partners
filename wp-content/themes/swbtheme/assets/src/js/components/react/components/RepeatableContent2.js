...
const RepeatableContent2 = props => {
  const rcParasEn = props.acf._np_rc_2_paragraphs_en;
  const rcParasFr = props.acf._np_rc_2_paragraphs_fr;
  const rcParas = props.browserLang === "en" ? rcParasEn : rcParasFr;

  const rcImgEn = props.acf._np_r_c_2_images_en;
  const rcImgFr = props.acf._np_rc_2_images_fr;
